...
from chapter07.authentication.app import app
from chapter07.authentication.database import get_async_session
from chapter07.authentication.models import AccessToken, Base, User
from chapter07.authentication.password import get_password_hash

DATABASE_FILE_PATH = "chapter07_authentication.test.db"
...
@pytest.mark.asyncio
class TestChapter07ProjectRegister:
...
@pytest.mark.asyncio
class TestChapter07ProjectToken:
    async def test_invalid_payload(self, client: httpx.AsyncClient):
...
@pytest.mark.asyncio
class TestChapter07ProjectProtectedRoute:
