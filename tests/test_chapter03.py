...
from chapter03.chapter03_custom_response_01 import (
    app as chapter03_custom_response_01_app,
)
from chapter03.chapter03_custom_response_02 import (
    app as chapter03_custom_response_02_app,
)
from chapter03.chapter03_custom_response_03 import (
    app as chapter03_custom_response_03_app,
)
from chapter03.chapter03_custom_response_04 import (
    app as chapter03_custom_response_04_app,
)
from chapter03.chapter03_custom_response_05 import (
    app as chapter03_custom_response_05_app,
)
from chapter03.chapter03_file_uploads_01 import app as chapter03_file_uploads_01_app
from chapter03.chapter03_file_uploads_02 import app as chapter03_file_uploads_02_app
from chapter03.chapter03_file_uploads_03 import app as chapter03_file_uploads_03_app
from chapter03.chapter03_first_endpoint_01 import app as chapter03_first_endpoint_01_app
from chapter03.chapter03_form_data_01 import app as chapter03_form_data_01_app
from chapter03.chapter03_headers_cookies_01 import (
    app as chapter03_headers_cookies_01_app,
)
from chapter03.chapter03_headers_cookies_02 import (
    app as chapter03_headers_cookies_02_app,
)
from chapter03.chapter03_headers_cookies_03 import (
    app as chapter03_headers_cookies_03_app,
)
from chapter03.chapter03_path_parameters_01 import (
    app as chapter03_path_parameters_01_app,
)
from chapter03.chapter03_path_parameters_02 import (
    app as chapter03_path_parameters_02_app,
)
from chapter03.chapter03_path_parameters_03 import (
    app as chapter03_path_parameters_03_app,
)
from chapter03.chapter03_path_parameters_04 import (
    app as chapter03_path_parameters_04_app,
)
from chapter03.chapter03_path_parameters_05 import (
    app as chapter03_path_parameters_05_app,
)
from chapter03.chapter03_path_parameters_06 import (
    app as chapter03_path_parameters_06_app,
)
from chapter03.chapter03_query_parameters_01 import (
    app as chapter03_query_parameters_01_app,
)
from chapter03.chapter03_query_parameters_02 import (
    app as chapter03_query_parameters_02_app,
)
from chapter03.chapter03_query_parameters_03 import (
    app as chapter03_query_parameters_03_app,
)
from chapter03.chapter03_raise_errors_01 import app as chapter03_raise_errors_01_app
from chapter03.chapter03_raise_errors_02 import app as chapter03_raise_errors_02_app
from chapter03.chapter03_request_body_01 import app as chapter03_request_body_01_app
from chapter03.chapter03_request_body_02 import app as chapter03_request_body_02_app
from chapter03.chapter03_request_body_03 import app as chapter03_request_body_03_app
from chapter03.chapter03_request_body_04 import app as chapter03_request_body_04_app
from chapter03.chapter03_request_object_01 import app as chapter03_request_object_01_app
from chapter03.chapter03_response_parameter_01 import (
    app as chapter03_response_parameter_01_app,
)
from chapter03.chapter03_response_parameter_02 import (
    app as chapter03_response_parameter_02_app,
)
from chapter03.chapter03_response_parameter_03 import (
    app as chapter03_response_parameter_03_app,
)
from chapter03.chapter03_response_path_parameters_01 import (
    app as chapter03_response_path_parameters_01_app,
)
from chapter03.chapter03_response_path_parameters_02 import (
    app as chapter03_response_path_parameters_02_app,
)
from chapter03.chapter03_response_path_parameters_03 import (
    app as chapter03_response_path_parameters_03_app,
)
from chapter03.chapter03_response_path_parameters_04 import (
    app as chapter03_response_path_parameters_04_app,
)


@pytest.mark.fastapi(app=chapter03_first_endpoint_01_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_path_parameters_01_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_path_parameters_02_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_path_parameters_03_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_path_parameters_04_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_path_parameters_05_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_path_parameters_06_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_query_parameters_01_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_query_parameters_02_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_query_parameters_03_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_request_body_01_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_request_body_02_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_request_body_03_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_request_body_04_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_form_data_01_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_file_uploads_01_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_file_uploads_02_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_file_uploads_03_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_headers_cookies_01_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_headers_cookies_02_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_headers_cookies_03_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_request_object_01_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_response_path_parameters_01_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_response_path_parameters_02_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_response_path_parameters_03_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_response_path_parameters_04_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_response_parameter_01_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_response_parameter_02_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_response_parameter_03_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_raise_errors_01_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_raise_errors_02_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_custom_response_01_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_custom_response_02_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_custom_response_03_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_custom_response_04_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter03_custom_response_05_app)
@pytest.mark.asyncio
