...
from chapter05.chapter05_class_dependency_01 import (
    app as chapter05_class_dependency_01_app,
)
from chapter05.chapter05_class_dependency_02 import (
    app as chapter05_class_dependency_02_app,
)
from chapter05.chapter05_function_dependency_01 import (
    app as chapter05_function_dependency_01_app,
)
from chapter05.chapter05_function_dependency_02 import (
    app as chapter05_function_dependency_02_app,
)
from chapter05.chapter05_function_dependency_03 import (
    app as chapter05_function_dependency_03_app,
)
from chapter05.chapter05_global_dependency_01 import (
    app as chapter05_global_dependency_01_app,
)
from chapter05.chapter05_path_dependency_01 import (
    app as chapter05_path_dependency_01_app,
)
from chapter05.chapter05_router_dependency_01 import (
    app as chapter05_router_dependency_01_app,
)
from chapter05.chapter05_router_dependency_02 import (
    app as chapter05_router_dependency_02_app,
)
from chapter05.chapter05_what_is_dependency_injection_01 import (
    app as chapter05_what_is_dependency_injection_01_app,
)


@pytest.mark.fastapi(app=chapter05_what_is_dependency_injection_01_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter05_function_dependency_01_app)
...
@pytest.mark.fastapi(app=chapter05_function_dependency_02_app)
@pytest.mark.parametrize("path", ["/items", "/things"])
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter05_function_dependency_03_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter05_class_dependency_01_app)
@pytest.mark.parametrize("path", ["/items", "/things"])
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter05_class_dependency_02_app)
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter05_router_dependency_01_app)
@pytest.mark.parametrize("path", ["/router/route1", "/router/route2"])
@pytest.mark.asyncio
class TestRouterDependency01:
    @pytest.mark.parametrize("secret_header", [None, "INVALID_VALUE"])
    async def test_invalid_header(
        self, client: httpx.AsyncClient, path: str, secret_header: str | None
    ):
        headers = {}
        if secret_header:
            headers["Secret-Header"] = secret_header
...
@pytest.mark.fastapi(app=chapter05_router_dependency_02_app)
@pytest.mark.parametrize("path", ["/router/route1", "/router/route2"])
@pytest.mark.asyncio
...
@pytest.mark.fastapi(app=chapter05_global_dependency_01_app)
