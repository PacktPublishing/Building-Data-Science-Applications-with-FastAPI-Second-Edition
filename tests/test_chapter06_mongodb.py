...
from chapter06.mongodb.app import app
...
database_test = motor_client["chapter06_mongo_test"]
initial_posts = [
...
async def initialize_database():
    ...
    await motor_client.drop_database("chapter06_mongo_test")
