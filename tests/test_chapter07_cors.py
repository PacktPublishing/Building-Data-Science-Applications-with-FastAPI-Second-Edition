...
from chapter07.cors.app_with_cors import app as app_with_cors
from chapter07.cors.app_without_cors import app as app_without_cors


@pytest.mark.fastapi(app=app_without_cors)
@pytest.mark.asyncio
class TestChapter07AppWithoutCORS:
...
@pytest.mark.asyncio
class TestChapter07AppWithCORS:
    async def test_options(self, client: httpx.AsyncClient):
        response = await client.options(
            "/",
            headers={
